...
class NationalityTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $nationalities_data_seed = [];
        foreach ($nationalities as $nationality) {

            $fake_nationality = Nationality::factory()->make([
                'name' => $nationality
            ])->toArray();
            $fake_nationality['name'] = json_encode($fake_nationality['name']);
            $nationalities_data_seed[] = $fake_nationality;
        }

        DB::table('nationalities')->insert($nationalities_data_seed);
