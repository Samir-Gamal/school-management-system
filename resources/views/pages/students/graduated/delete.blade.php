    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{__('student.deleted_Student')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('graduates.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{__('student.deleted_Student_tilte')}}</h5>
